...
// Flow rate detection
#define GRIND_FLOW_DETECTION_THRESHOLD_GPS 0.5f                           // Minimum coffee flow rate to establish grinding
...
#define GRIND_SCALE_SETTLING_TOLERANCE_G 0.005f                                 // Maximum standard deviation for settled reading
